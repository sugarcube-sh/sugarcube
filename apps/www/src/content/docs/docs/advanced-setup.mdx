...
| `--variables-filename <name>` | Custom filename for generated CSS variables (e.g., `token-variables.css`) |
| `--utilities-dir <dir>` | Custom directory for generated utility classes (e.g., `./css/utilities`) |
| `--utilities-filename <name>` | Custom filename for generated utility classes (e.g., `token-utils.css`) |
...
All commands support zero-config auto-discovery. See [CLI commands](/docs/reference/cli-commands) for more details.