...
**Using the Vite plugin?** You only need a config file if you want to customize any settings (output directories, filenames, etc.).
...
Create a `sugarcube.config.ts` (or `.js`) in your project root when you want to customize any defaults:
