...
| `--styles-dir <dir>` | CSS output directory | Auto-detected based on `src/` |
...
npx sugarcube generate --styles-dir dist/styles
...
# [sugarcube] colors.json → src/styles/global/tokens.variables.gen.css (38ms)
```
...
| `--cube-dir <dir>` | CUBE CSS output directory (auto-detected based on `src/`, or config's cssRoot) |
</Table>
