...
sugarcube generate --resolver ./tokens.resolver.json

# Custom output directories
sugarcube generate --styles-dir dist/styles

# Override fluid viewport range
sugarcube generate --fluid-min 375 --fluid-max 1440

# Use polyfill for wide gamut colors
sugarcube generate --color-fallback polyfill
...
sugarcube generate --fluid-max 1600
```
...
sugarcube validate src/design-tokens
sugarcube validate tokens/colors.json tokens/spacing.json

# Validate multiple paths
sugarcube validate src/tokens/colors src/tokens/spacing
```
...
```bash frame="none"
sugarcube components [components...] [options]
```
...
sugarcube components button card --framework react

# Install CSS-only components
sugarcube components button --framework css-only

# Specify custom output directory
sugarcube components button --components-dir src/ui

# Overwrite existing files
sugarcube components button --overwrite
```
...
# Specify custom output directory
sugarcube cube --cube-dir src/styles/cube

# Skip overwrite confirmation
sugarcube cube --force

# Silent mode
sugarcube cube --silent
```
