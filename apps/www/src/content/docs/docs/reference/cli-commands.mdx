...
|--------|-------------|---------|
| `--tokens-dir <dir>` | Design tokens directory | Auto-detected based on `src/` |
| `--cube-dir <dir>` | CUBE CSS output directory | Auto-detected based on `src/` |
| `--components-dir <dir>` | Components output directory | Auto-detected based on `src/` |
</Table>
...
npx @sugarcube-sh/cli init --tokens-dir ./tokens --cube-dir ./css
```
...
| `--components-dir <dir>` | Components output directory (auto-detected based on `src/`, or from config) |
| `-s, --silent` | Suppress logs and prompts |
...
npx sugarcube components button --components-dir src/ui
...
- **Works without a config file**: Defaults to `src/components/ui` or `components/ui` based on whether your project has a `src/` directory. Use `--components-dir` to override.
...
| `--cube-dir <dir>` | CUBE CSS output directory (auto-detected based on `src/`, or from config) |
</Table>
...
# Specify custom output directory
npx sugarcube cube --cube-dir src/styles/cube
...
- **Works without a config file**: Defaults to `src/styles` or `styles` based on whether your project has a `src/` directory. Use `--cube-dir` to override.
- **Does not modify config files** - flag values are temporary for the command run
