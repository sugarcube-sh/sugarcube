...
<SiteAside type="note">
    ...
    An option to output or introspect the generated tokens is in active development. Open an [issue](https://github.com/sugarcube-sh/sugarcube/issues) or [discussion](https://github.com/sugarcube-sh/sugarcube/discussions) if you’d like to see this feature.
</SiteAside>
