---
title: Introduction
description: Learn what sugarcube is and why it exists.
---
...
Teams often reinvent these foundations on every project, leading to inconsistency, duplication, and systems that are difficult to change.
