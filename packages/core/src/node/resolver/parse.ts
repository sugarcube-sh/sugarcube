...
import { WarningMessages } from "../../shared/constants/warning-messages.js";
import { usesPrefersColorScheme } from "../../shared/extensions.js";
import { hasRef, isInlineModifier, isInlineSet } from "../../shared/guards.js";
import { resolverDocumentSchema } from "../../shared/schemas/resolver.js";
import type {
    InlineModifier,
    InlineSet,
    ModifierDefinition,
